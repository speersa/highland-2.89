...
TString in_h2_p6t="hist_fth2_"+key[0]+"_500toys_6Brun5c_6Btables"+key2[0]+".root";//highland2 6B files 6B tables
TString in_h2_p5t="hist_fth2_"+key[0]+"_500toys_6Brun5c_5Ftables"+key2[0]+".root";//highland2 6B files 5F tables
TString inh2sand="hist_fth2_"+key[0]+"_500toys_6Brun5cSAND_6Btables"+key2[0]+".root";//sand
...
gStyle->SetOptStat(1110);
  ...
  TString nn[3]={"CC","CC1trk","CCNtrk"};
  TString path="antiNumuCCFGD1";
...
void compareprodsysthist(int opt){
  ...
  TFile *inf[2];
  inf[0]=new TFile(in_h2_p6t.Data(),"READ");
  inf[1]=new TFile(in_h2_p5t.Data(),"READ"); 
  ...
  for(int isyst=0;isyst<NSYST;isyst++){
	...
	if(hh[ih][iff])hh[ih][iff]->GetYaxis()->SetRangeUser(0.,vmax*1.1);
      ...
      leg->Draw("same");
      c1[ih]->Print(Form("antiNumuValidation/%s_%s.png",name.Data(),nn[ih].Data()));
    }
    txtfile<<"\\\\ \n";
  }
  txtfile<<"TOTAL";
