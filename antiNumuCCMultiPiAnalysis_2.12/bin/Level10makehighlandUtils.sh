...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandUtils_2.46 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandUtils_2.46  FAILED   ( Level = 10 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandUtils_2.46  ( package number " 10 " out of " 21 " at level 10 ) " ; echo "" 
   makeTarget=$1 
