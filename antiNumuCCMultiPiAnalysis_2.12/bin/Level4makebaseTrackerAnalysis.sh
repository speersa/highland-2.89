...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package baseTrackerAnalysis_2.26 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/baseTrackerAnalysis_2.26  FAILED   ( Level = 4 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building baseTrackerAnalysis_2.26  ( package number " 17 " out of " 21 " at level 4 ) " ; echo "" 
   makeTarget=$1 
