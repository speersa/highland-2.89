...
//********************************************************************
  ...
  _numuCCMultiPiAnalysis->SetAddPionSIinfo((bool)ND::params().GetParameterI("antiNumuCCMultiPiAnalysis.MicroTrees.AddPionSIinfo"));
  
  
  _numuCCMultiPiAnalysis->InitializeAddPionSIinfo();
