...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandTools_2.32 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandTools_2.32  FAILED   ( Level = 2 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandTools_2.32  ( package number " 15 " out of " 16 " at level 2 ) " ; echo "" 
   makeTarget=$1 
