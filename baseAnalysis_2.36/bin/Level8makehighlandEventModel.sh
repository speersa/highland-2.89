...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandEventModel_2.43 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandEventModel_2.43  FAILED   ( Level = 8 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandEventModel_2.43  ( package number " 7 " out of " 16 " at level 8 ) " ; echo "" 
   makeTarget=$1 
