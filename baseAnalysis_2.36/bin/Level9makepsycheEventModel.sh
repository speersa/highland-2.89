...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheEventModel_3.47 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheEventModel_3.47  FAILED   ( Level = 9 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheEventModel_3.47  ( package number " 3 " out of " 16 " at level 9 ) " ; echo "" 
   makeTarget=$1 
