...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package baseP0DAnalysis_2.7 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/baseP0DAnalysis_2.7  FAILED   ( Level = 1 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building baseP0DAnalysis_2.7  ( package number " 17 " out of " 17 " at level 1 ) " ; echo "" 
   makeTarget=$1 
