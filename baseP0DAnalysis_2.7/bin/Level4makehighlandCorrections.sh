...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandCorrections_2.33 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandCorrections_2.33  FAILED   ( Level = 4 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandCorrections_2.33  ( package number " 13 " out of " 17 " at level 4 ) " ; echo "" 
   makeTarget=$1 
