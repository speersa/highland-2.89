...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package baseAnalysis_2.36 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/baseAnalysis_2.36  FAILED   ( Level = 2 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building baseAnalysis_2.36  ( package number " 16 " out of " 17 " at level 2 ) " ; echo "" 
   makeTarget=$1 
