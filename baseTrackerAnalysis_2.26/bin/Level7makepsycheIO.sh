...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheIO_3.40 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheIO_3.40  FAILED   ( Level = 7 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheIO_3.40  ( package number " 9 " out of " 17 " at level 7 ) " ; echo "" 
   makeTarget=$1 
