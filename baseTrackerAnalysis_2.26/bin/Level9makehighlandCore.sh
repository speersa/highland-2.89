...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandCore_2.46 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandCore_2.46  FAILED   ( Level = 9 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandCore_2.46  ( package number " 6 " out of " 17 " at level 9 ) " ; echo "" 
   makeTarget=$1 
