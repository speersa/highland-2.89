...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandCorrections_2.33 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandCorrections_2.33  FAILED   ( Level = 10 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandCorrections_2.33  ( package number " 16 " out of " 35 " at level 10 ) " ; echo "" 
   makeTarget=$1 
