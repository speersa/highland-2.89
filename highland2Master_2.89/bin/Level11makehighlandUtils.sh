...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandUtils_2.46 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandUtils_2.46  FAILED   ( Level = 11 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandUtils_2.46  ( package number " 15 " out of " 35 " at level 11 ) " ; echo "" 
   makeTarget=$1 
