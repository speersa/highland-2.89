...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandEventModel_2.43 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandEventModel_2.43  FAILED   ( Level = 12 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandEventModel_2.43  ( package number " 13 " out of " 35 " at level 12 ) " ; echo "" 
   makeTarget=$1 
