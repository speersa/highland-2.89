...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandTools_2.32 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandTools_2.32  FAILED   ( Level = 12 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandTools_2.32  ( package number " 14 " out of " 35 " at level 12 ) " ; echo "" 
   makeTarget=$1 
