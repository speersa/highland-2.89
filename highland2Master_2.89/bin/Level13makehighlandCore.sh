...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandCore_2.46 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandCore_2.46  FAILED   ( Level = 13 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandCore_2.46  ( package number " 11 " out of " 35 " at level 13 ) " ; echo "" 
   makeTarget=$1 
