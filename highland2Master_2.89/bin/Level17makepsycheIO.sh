...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheIO_3.40 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheIO_3.40  FAILED   ( Level = 17 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheIO_3.40  ( package number " 6 " out of " 35 " at level 17 ) " ; echo "" 
   makeTarget=$1 
