...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheROOT_3.10 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheROOT_3.10  FAILED   ( Level = 22 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheROOT_3.10  ( package number " 1 " out of " 35 " at level 22 ) " ; echo "" 
   makeTarget=$1 
