...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package baseP0DAnalysis_2.7 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/baseP0DAnalysis_2.7  FAILED   ( Level = 3 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building baseP0DAnalysis_2.7  ( package number " 32 " out of " 35 " at level 3 ) " ; echo "" 
   makeTarget=$1 
