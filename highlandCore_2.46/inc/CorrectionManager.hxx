...
public:
  ...
  /// Set the order of the corrections
  /// User has to provide a set of names of the corrections 
  /// The names mentioned in the list will be put in the given order starting
  /// from the first,  the non-mentioned ones will be added afterwards assuming
  /// the order is not important for them
  void SetCorrectionsOrder(const std::vector<std::string>& order_set);
