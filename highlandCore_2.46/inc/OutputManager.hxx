...
public :
  ...
  /// Fill a toy vector analysis variable
  ...
  ///  Fill a toy vector analysis variable given an array
  void FillToyVectorVarFromArray(Int_t index, const Int_t    var[], UInt_t size) {for (UInt_t i=0;i<size;i++) FillToyVectorVar(index,(Int_t)var[i]    ,i);}
  void FillToyVectorVarFromArray(Int_t index, const Float_t  var[], UInt_t size) {for (UInt_t i=0;i<size;i++) FillToyVectorVar(index,(Float_t)var[i]  ,i);}
  void FillToyVectorVarFromAray(Int_t  index, const Double_t var[], UInt_t size) {for (UInt_t i=0;i<size;i++) FillToyVectorVar(index,(Double_t)var[i] ,i);}
  ...
  /// Fill a toy matrix analysis variable
  ...
  /// Fill a toy matrix analysis variable given an array
  void FillToyMatrixVarFromArray(Int_t index, Int_t    var[], Int_t indx1, UInt_t size) {for (UInt_t i=0;i<size;i++) FillToyMatrixVar(index,(Int_t)var[i],   indx1,i);}
  void FillToyMatrixVarFromArray(Int_t index, Float_t  var[], Int_t indx1, UInt_t size) {for (UInt_t i=0;i<size;i++) FillToyMatrixVar(index,(Float_t)var[i], indx1,i);}
  void FillToyMatrixVarFromArray(Int_t index, Double_t var[], Int_t indx1, UInt_t size) {for (UInt_t i=0;i<size;i++) FillToyMatrixVar(index,(Int_t)var[i],   indx1,i);}
 ...
 protected:
  ...
  /// A flag to control when to run ROOT`s basket optimisation
...
#define AddToyVar3VF(out, name, doc)  out.AddToyVectorVar(name,#name,"F",doc,3);
#define AddToyVar4VF(out, name, doc)  out.AddToyVectorVar(name,#name,"F",doc,4);

#define AddToyVar3VD(out, name, doc)  out.AddToyVectorVar(name,#name,"D",doc,3);
#define AddToyVar4VD(out, name, doc)  out.AddToyVectorVar(name,#name,"D",doc,4);
