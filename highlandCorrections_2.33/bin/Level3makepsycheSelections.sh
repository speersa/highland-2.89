...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheSelections_3.60 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheSelections_3.60  FAILED   ( Level = 3 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheSelections_3.60  ( package number " 11 " out of " 13 " at level 3 ) " ; echo "" 
   makeTarget=$1 
