...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheIO_3.40 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheIO_3.40  FAILED   ( Level = 5 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheIO_3.40  ( package number " 9 " out of " 14 " at level 5 ) " ; echo "" 
   makeTarget=$1 
