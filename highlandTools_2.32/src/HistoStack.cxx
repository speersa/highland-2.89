...
//*******************************************************
  ...
  std::map<std::string, TH2_h*>::iterator itm2;

  for (itm2 = _hsyst.begin(); itm2 != _hsyst.end(); itm2++)
...
//*******************************************************
  ...
  if (_histos1D_draw.size()>0){
    for (std::vector<TH1_h*>::iterator it1 = _histos1D_draw.begin(); it1 != _histos1D_draw.end(); it1++)
      delete *it1;
...
//********************************************************
TH1_h* HistoStack::GetHisto1D(const std::string& title) {
//*******************************************************

  if (_histos1D.size() > 0) {
    std::vector<TH1_h*>::reverse_iterator rit1;
...
//********************************************************
TH1_h* HistoStack::GetHisto1D(Int_t index) {
//*******************************************************
...
//********************************************************
TH2_h* HistoStack::GetHisto2D(const std::string& title) {
//*******************************************************

  if (_histos2D.size() > 0) {
    std::vector<TH2_h*>::reverse_iterator rit1;
...
//********************************************************
TH2_h* HistoStack::GetHisto2D(Int_t index) {
//*******************************************************
...
//*******************************************************
  ...
  if (_is1D) {
    ...
    _hall1D_draw = new TH1_h(*_hall1D);
    Double_t min_width;
...
//********************************************************
void HistoStack::AddTotal(TH1_h* h1, TH1_h* hsyst) {
//*******************************************************
  ...
  if (_currentSystGroup == "default"){ 
    if (_hall1D){
      ...
      _hall1D      = new TH1_h(*h1);
      _hall1D_stat = new TH1_h(*h1);
      if (hsyst){
        _hall1D_syst = new TH1_h(*h1);
      }
    }
  }
...
//********************************************************
void HistoStack::AddTotal(TH2_h* h2) {
//*******************************************************
  ...
  if (_hall2D)
    ...
    _hall2D = new TH2_h(*h2);
}


//********************************************************
void HistoStack::AddSystHisto(TH2_h* h2){
//*******************************************************

  std::string group =  _currentSystGroup;

  if (group==""){
    std::cout << "Error in HistoStack::AddSystHisto !!!  Current Systematics Group not specified !!!" << std::endl;
    return;
  }

  if (_hsyst.find(group)!=_hsyst.end()){
    _hsyst[group]->Add(h2);
     return;
  }

  AddSystHistoGroup(group);

  _hsyst[group] = new TH2_h(*h2);
  _hsyst[group]->SetName("h2p");
}

//********************************************************
void HistoStack::GetSystHisto(const std::string& group, TH2_h*& h2){
//*******************************************************
...
//********************************************************
void HistoStack::Add(TH1_h* h1, int lc, int lw, int fc, int fs,const std::string& leg) {
//*******************************************************
...
//********************************************************
void HistoStack::Add(TH2_h* h2, int fc, int lc, const std::string& leg) {
//*******************************************************
...
//*********************************************************
  ...
  std::vector<TH1_h*>::const_iterator rit1;
