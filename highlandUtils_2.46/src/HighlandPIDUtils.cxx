...
//********************************************************************
  ...
  // cast the track
  const AnaTPCParticle& track = *static_cast<const AnaTPCParticle*>(&trackB);
...
//********************************************************************
void anaUtils::GetPIDLikelihoodIncludingKaon(const AnaTrackB& track, Float_t* hypo, bool prod5Cut) {
//********************************************************************
    ...
    for (int j = 0; j < track.nTPCSegments; ++j){
        ...
        AnaTPCParticle* TPCSegmentK = (AnaTPCParticle*)TPCSegment;
...
//********************************************************************
Float_t anaUtils::GetPIDLikelihoodIncludingKaon(const AnaTrackB& track, Int_t hypo, bool prod5Cut) {
//********************************************************************
