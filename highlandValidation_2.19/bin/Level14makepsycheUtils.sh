...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheUtils_3.36 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheUtils_3.36  FAILED   ( Level = 14 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheUtils_3.36  ( package number " 5 " out of " 28 " at level 14 ) " ; echo "" 
   makeTarget=$1 
