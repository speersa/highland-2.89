...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package nueCCAnalysis_2.30 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/nueCCAnalysis_2.30  FAILED   ( Level = 3 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building nueCCAnalysis_2.30  ( package number " 23 " out of " 28 " at level 3 ) " ; echo "" 
   makeTarget=$1 
