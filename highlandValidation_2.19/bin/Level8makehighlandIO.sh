...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandIO_2.53 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandIO_2.53  FAILED   ( Level = 8 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandIO_2.53  ( package number " 14 " out of " 28 " at level 8 ) " ; echo "" 
   makeTarget=$1 
