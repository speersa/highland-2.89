...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package nueCCAnalysis_2.30 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/nueCCAnalysis_2.30  FAILED   ( Level = 1 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building nueCCAnalysis_2.30  ( package number " 18 " out of " 18 " at level 1 ) " ; echo "" 
   makeTarget=$1 
