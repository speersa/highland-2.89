...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandUtils_2.46 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/highlandUtils_2.46  FAILED   ( Level = 8 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building highlandUtils_2.46  ( package number " 10 " out of " 18 " at level 8 ) " ; echo "" 
   makeTarget=$1 
