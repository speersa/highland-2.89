...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheROOT_3.10 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheROOT_3.10  FAILED   ( Level = 13 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheROOT_3.10  ( package number " 1 " out of " 18 " at level 13 ) " ; echo "" 
   makeTarget=$1 
