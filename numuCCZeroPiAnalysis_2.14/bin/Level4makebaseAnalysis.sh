...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package baseAnalysis_2.36 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/baseAnalysis_2.36  FAILED   ( Level = 4 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building baseAnalysis_2.36  ( package number " 16 " out of " 20 " at level 4 ) " ; echo "" 
   makeTarget=$1 
