...
public:
// Data Members.
   TVector3    First_Radon_Line;    ///< Direction of the first 3D radon line
   TVector3    Second_Radon_Line;    ///< Direction of the second 3D radon line
   TVector3    Third_Radon_Line;     ///< Direction of the third 3D radon line
   int         First_Radon_Line_Hits;    ///< NHits in the first 3D radon line
   int         Second_Radon_Line_Hits;    ///< NHits in the second 3D radon line;
   int         Third_Radon_Line_Hits;     ///< NHits in the third 3D radon line
   int         Radon_XY_First_Prong_NHits;    ///< NHits in the first XY radon prong
   int         Radon_XY_First_Prong_Angle;    ///< Angle of the first XY prong
   int         Radon_XY_First_Prong_Distance;    ///< Perpendicular distance from cluster centre of first XY line
   int         Radon_XY_Second_Prong_NHits;      ///< NHits in the second XY radon prong
   int         Radon_XY_Second_Prong_Angle;      ///< Angle of the second XY prong
   int         Radon_XY_Second_Prong_Distance;    ///< Perpendicular distance from cluster centre of second XY line
   int         Radon_XY_Third_Prong_NHits;        ///< NHits in the third XY radon prong
   int         Radon_XY_Third_Prong_Angle;        ///< Angle of the third XY prong
   int         Radon_XY_Third_Prong_Distance;     ///< Perpendicular distance from cluster centre of third XY line
   int         Radon_XZ_First_Prong_NHits;        ///< NHits in the first XZ radon prong
   int         Radon_XZ_First_Prong_Angle;        ///< Angle of the first XZ prong
   int         Radon_XZ_First_Prong_Distance;     ///< Perpendicular distance from cluster centre of first XZ line
   int         Radon_XZ_Second_Prong_NHits;       ///< NHits in the second XZ radon prong
   int         Radon_XZ_Second_Prong_Angle;       ///< Angle of the second XZ prong
   int         Radon_XZ_Second_Prong_Distance;    ///< Perpendicular distance from cluster centre of second XZ line
   int         Radon_XZ_Third_Prong_NHits;        ///< NHits in the third XZ radon prong
   int         Radon_XZ_Third_Prong_Angle;        ///< Angle of the third XZ prong
   int         Radon_XZ_Third_Prong_Distance;     ///< Perpendicular distance from cluster centre of third XZ line
   int         Radon_YZ_First_Prong_NHits;        ///< NHits in the first YZ radon prong
   int         Radon_YZ_First_Prong_Angle;        ///< Angle of the first YZ prong
   int         Radon_YZ_First_Prong_Distance;     ///< Perpendicular distance from cluster centre of first YZ line
   int         Radon_YZ_Second_Prong_NHits;       ///< NHits in the second YZ radon prong
   int         Radon_YZ_Second_Prong_Angle;       ///< Angle of the second YZ prong
   int         Radon_YZ_Second_Prong_Distance;    ///< Perpendicular distance from cluster centre of second YZ line
   int         Radon_YZ_Third_Prong_NHits;        ///< NHits in the third YZ radon prong
   int         Radon_YZ_Third_Prong_Angle;        ///< Angle of the third YZ prong
   int         Radon_YZ_Third_Prong_Distance;     ///< Perpendicular distance from cluster centre of third YZ line
