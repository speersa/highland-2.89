...
// Data Members.
   ...
   double      MumonICTotalQ;               //MUMON Total Charge measured by theionization chambers.
   double      MumonICPeak;                 //MUMON Peak measured by the ionization chambers.
   double      MumonICX;                    //Beam X Position on MUMON measured by theionization chambers [mm]
   double      MumonICwX;                   //Beam X Width on MUMON measured by the ionizationchambers [mm]
   double      MumonICY;                    //Beam Y Position on MUMON measured by theionization chambers [mm]
   double      MumonICwY;                   //Beam Y Width on MUMON measured by the ionizationchambers [mm]
   ...
   int         GoodSpillFlag;               //Status Flag of Spill. This Flag contains allinformation above and should be used to defindethe flag is suitable for physics analysis or not.0 = BAD.  Any others starts depending on runconditions.
