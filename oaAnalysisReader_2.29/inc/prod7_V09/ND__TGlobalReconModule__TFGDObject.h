...
// Data Members.
   ...
   vector<int> fgdhits_Layer;                  //Vector to store the layer number of each hit
   vector<TVector3> fgdhits_Position;               //Vector to store the X or Y position of each hit
   vector<float>    fgdhits_Time;                   //Vector to store the time of each hit
   vector<float>    fgdhits_Charge;                 //Vector to store the charge of each hit
   vector<int>      fgdhits_TrajID;                 //Vector to store the ID of the Trajectory that created the hit
   vector<float>    fgdhits_TrueE;                  //Vector to store the true energy deposit of each hit

   TFGDObject();
   TFGDObject(const TFGDObject & );
   virtual ~TFGDObject();

   ClassDef(TFGDObject,3); // Generated by MakeProject.
};
} // namespace
} // namespace
#endif
