...
ND::TTrackerECALReconModule::TECALReconObject::TECALReconObject(const TECALReconObject & rhs)
   ...
   , First_Radon_Line(const_cast<TECALReconObject &>( rhs ).First_Radon_Line)
   , Second_Radon_Line(const_cast<TECALReconObject &>( rhs ).Second_Radon_Line)
   , Third_Radon_Line(const_cast<TECALReconObject &>( rhs ).Third_Radon_Line)
   , First_Radon_Line_Hits(const_cast<TECALReconObject &>( rhs ).First_Radon_Line_Hits)
   , Second_Radon_Line_Hits(const_cast<TECALReconObject &>( rhs ).Second_Radon_Line_Hits)
   , Third_Radon_Line_Hits(const_cast<TECALReconObject &>( rhs ).Third_Radon_Line_Hits)
...
ND::TGlobalReconModule::TTPCObject::TTPCObject(const TTPCObject & rhs)
   ...
   , RefitPosition(const_cast<TTPCObject &>( rhs ).RefitPosition)
   , RefitDirection(const_cast<TTPCObject &>( rhs ).RefitDirection)
   , RefitMomentum(const_cast<TTPCObject &>( rhs ).RefitMomentum)
   , RefitCharge(const_cast<TTPCObject &>( rhs ).RefitCharge)
{
   // This is NOT a copy constructor. This is actually a move constructor (for stl container's sake).
   // Use at your own risk!
   if (&rhs) {} // avoid warning about unused parameter
