...
ND::TTrackerECALReconModule::TECALReconObject::TECALReconObject(const TECALReconObject & rhs)
   ...
   , KFNNodesEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFNNodesEcalStandAlone)
   , KFMultiTracksTPCEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFMultiTracksTPCEcalStandAlone)
   , KFMultiTracksECALEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFMultiTracksECALEcalStandAlone)
   , KFNDOFEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFNDOFEcalStandAlone)
   , KFQualityEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFQualityEcalStandAlone)
   , KFParameterEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFParameterEcalStandAlone)
   , KFParameterNodesEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFParameterNodesEcalStandAlone)
   , KFHitQualityEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFHitQualityEcalStandAlone)
   , KFIsMatchedEcalStandAlone(const_cast<TECALReconObject &>( rhs ).KFIsMatchedEcalStandAlone)
...
ND::TGlobalReconModule::TFGDObject::TFGDObject(const TFGDObject & rhs)
   ...
   , TrueE(const_cast<TFGDObject &>( rhs ).TrueE)
   ...
   , fgdhits_TrueE(const_cast<TFGDObject &>( rhs ).fgdhits_TrueE)
{
   // This is NOT a copy constructor. This is actually a move constructor (for stl container's sake).
   // Use at your own risk!
   if (&rhs) {} // avoid warning about unused parameter
...
ND::TGlobalReconModule::TTPCObject::TTPCObject(const TTPCObject & rhs)
   ...
   , KalmanFitType(const_cast<TTPCObject &>( rhs ).KalmanFitType)
{
   // This is NOT a copy constructor. This is actually a move constructor (for stl container's sake).
   // Use at your own risk!
   if (&rhs) {} // avoid warning about unused parameter
...
ND::TGlobalReconModule::TFgdTimeBin::TFgdTimeBin(const TFgdTimeBin & rhs)
   ...
   , FGD1HitTrueE(const_cast<TFgdTimeBin &>( rhs ).FGD1HitTrueE)
   ...
   , FGD2HitTrueE(const_cast<TFgdTimeBin &>( rhs ).FGD2HitTrueE)
