...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package p0dNumuCCAnalysis_2.17 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/p0dNumuCCAnalysis_2.17  FAILED   ( Level = 1 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building p0dNumuCCAnalysis_2.17  ( package number " 19 " out of " 19 " at level 1 ) " ; echo "" 
   makeTarget=$1 
