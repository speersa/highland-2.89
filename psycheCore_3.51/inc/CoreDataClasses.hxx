...
const UInt_t NMAXRECOBJECTGROUPS = 50;
...
class AnaRecObjectC{
 ...
 public:
  ...
  /// The ID of the trueObj, which corresponds to the ID of the TTruthParticle that created it
  /// to store in a mini-tree and later association
  Int_t TrueID;
};
...
class AnaSpillC{
 public :
  ...
  /// With a boolean to be able to treat differently e.g. cloning and mini-tree
  /// cases
  virtual void RedoLinks(bool full = false) = 0;
...
class AnaEventC{
 ...
 public:
  ...
  /// The data quality flags for this event.
