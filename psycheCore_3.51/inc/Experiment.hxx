...
public:
  ...
  SampleGroup(const std::string& name, DataSample* dataSample, DataSample* mcSample=NULL);
  SampleGroup(const std::string& name, const std::string& dataFile, std::map<std::string, std::string>& mcFiles);
  SampleGroup(const std::string& name, const std::string& dataFile, const std::string& mcFile="");
...
class Experiment{
 public :
  ...
  /// Create an experiment provided a data and a MC sample
  Experiment(const std::string& name, DataSample* s1, DataSample* s2=NULL);
  ...
  /// Add a group of samples (normally data and MC). A DataSample object 
  /// will be generated internally for each.
  void AddSampleGroup(const std::string& name, const std::string& dataFile, const std::string& mcFile="");
  ...
  /// Add group of samples (normally data and MC).
  void AddSampleGroup(const std::string& name, DataSample* dataFile, DataSample* mcSample=NULL);
