...
class InputConverter {
  ...
  public:
    ...
    /// Record the POT for the current spill (if there is one available locally)
    virtual void IncrementPOTBySpill() = 0;
    
    /// Record the POT given a spill
    virtual void IncrementPOTBySpill(const AnaSpillC*){};
  ...
  protected:
    ...
    // Name of the current file being read
