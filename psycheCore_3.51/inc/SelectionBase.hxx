...
/// future.
const UInt_t NMAXBRANCHES=40;

/// The maximum number of selections that is supported.
const UInt_t NMAXSELECTIONS=32;
...
public:
  ...
  //-----------------------------------------------------------------
  virtual void InitializeToy(const AnaEventC* event = NULL)const{}
  ...
  //-----------------------------------------------------------------
  virtual void FinalizeToy(const AnaEventC* event = NULL)const{}
...
protected:
  ...
  /// A boolean to check whether to apply checkredoselection method to speed up
  /// the toys
  bool _useCheckRedoSelection;
};
