...
//********************************************************************
  ...
  // Get the recObject groups relevant for this systematic
  Int_t* groups;
  ...
  if (nGroups>0){
    ...
    if (box.nRelevantRecObjects != nMaxRecObjects)
      anaUtils::ResizeArray(box.RelevantRecObjects, box.nRelevantRecObjects, nMaxRecObjects);
  }
  ...
  anaUtils::CreateArray(groups,NMAXTRUEOBJECTGROUPS);
  Int_t nTrueGroups = sel.GetRelevantTrueObjectGroupsForSystematic(_index, groups, ibranch);
  anaUtils::ResizeArray(groups,nTrueGroups, NMAXTRUEOBJECTGROUPS);
  ...
  if (nTrueGroups>0){
    ...
    if (box.nRelevantTrueObjects != nMaxRecObjects)
      anaUtils::ResizeArray(box.RelevantTrueObjects, box.nRelevantTrueObjects, nMaxRecObjects);
  }
