...
//********************************************************************
SampleGroup::SampleGroup(const std::string& name, const std::string& dataFile, const std::string & mcFile){
//********************************************************************

    _name = name; 
    if (dataFile!= "") AddDataSample(dataFile);
    if (mcFile  != "") AddMCSample("mc",mcFile);
}
...
//********************************************************************
SampleGroup::SampleGroup(const std::string& name, DataSample* dataSample, DataSample* mcSample){
//********************************************************************

    _name = name; 
    if (dataSample) AddDataSample(dataSample);
    if (mcSample  ) AddMCSample("mc",mcSample);
}
...
//**************************************************
    ...
    for (mit = mcSamples.begin(); mit != mcSamples.end(); mit++) {
        ...
        TString tstr(mit->first);
        tstr.ToUpper();
        std::string sstr(tstr.Data());
        
        if(sstr.find("SAND") != std::string::npos){
...
//**************************************************
Experiment::Experiment(const std::string& name, DataSample* s1, DataSample* s2) {
//**************************************************
...
//**************************************************
void Experiment::AddSampleGroup(const std::string& name, const std::string& dataFile, const std::string& mcFile){
//**************************************************

    _sampleGroups[name] = SampleGroup(name, dataFile, mcFile);
    AddSampleFilesToVector(_sampleGroups[name]);  
    _filePath = dataFile;
}
...
//**************************************************
void Experiment::AddSampleGroup(const std::string& name, DataSample* dataSample, DataSample* mcSample){
//**************************************************

    _sampleGroups[name] = SampleGroup(name, dataSample, mcSample);
    AddSampleFilesToVector(_sampleGroups[name]);  
