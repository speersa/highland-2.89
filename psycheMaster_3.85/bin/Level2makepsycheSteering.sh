...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheSteering_3.46 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheSteering_3.46  FAILED   ( Level = 2 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheSteering_3.46  ( package number " 9 " out of " 10 " at level 2 ) " ; echo "" 
   makeTarget=$1 
