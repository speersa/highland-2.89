...
public:
  ...
  /// ctor
  PionSIManager(){
    _useNEUTCascade = ((bool)ND::params().GetParameterI("psycheND280Utils.PionSI.UseNEUTCascade") || 
  ...
  virtual Bool_t InVOI(SubDetId_h det, const Float_t* pos, const Float_t* arr1, const Float_t* arr2) const;
  ...
  virtual Bool_t CheckLookForInteraction(SubDetId_h det, const AnaTrueParticleB& particle, const Float_t* arr1, const Float_t* arr2) const;
  ...
  PionInteractionSystematic* ComputePionWeightInfo(const AnaEventB& event, SubDetId_h det, const Float_t* arr1 = NULL, const Float_t* arr2 = NULL) const;


  PionInteractionSystematic* ComputePionWeightInfo(const AnaEventB& event, const SelectionBase& sel, 
      Int_t branch, const Float_t* arr1 = NULL, const Float_t* arr2 = NULL) const{
    return ComputePionWeightInfo(event, sel.GetDetectorFV(branch), arr1, arr2); 
  
  }
  
  Int_t GetMaterialSeries(std::string matName) const;
  
private:
  bool _useNEUTCascade;
 
}; 

class PionSIManager4Pi : public PionSIManager{

  Bool_t InVOI1(const Float_t* pos) const;
  Bool_t InVOIext(const Float_t* pos) const;
};
