...
set base=$PSYCHEND280UTILSROOT/$PSYCHEND280UTILSCONFIG/lib 
set base1=$PSYCHECOREROOT/$PSYCHECORECONFIG/lib 
set base2=$PSYCHEEVENTMODELROOT/$PSYCHEEVENTMODELCONFIG/lib
set base3=$PSYCHEUTILSROOT/$PSYCHEUTILSCONFIG/lib 
...
if ( -d $base ); then
  ...
  set includes=$PSYCHEND280UTILSROOT/inc/*_LinkDef.h
