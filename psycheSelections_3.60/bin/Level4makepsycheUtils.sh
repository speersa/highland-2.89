...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheUtils_3.36 in  /home/t2k/aspeers/Highland_Installs/HighLAND_2.89/psycheUtils_3.36  FAILED   ( Level = 4 )       " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheUtils_3.36  ( package number " 4 " out of " 7 " at level 4 ) " ; echo "" 
   makeTarget=$1 
