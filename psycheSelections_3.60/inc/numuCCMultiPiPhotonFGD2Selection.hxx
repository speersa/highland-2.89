#ifndef numuCCMultiPiPhotonFGD2Selection_h
#define numuCCMultiPiPhotonFGD2Selection_h
...
class numuCCMultiPiPhotonFGD2Selection: public numuCCMultiPiFGD2Selection{

public:
  numuCCMultiPiPhotonFGD2Selection(bool forceBreak=true);
  
  virtual ~numuCCMultiPiPhotonFGD2Selection(){}
  ...
  void SetDetectorFV(SubDetId_h det, Int_t ibranch=-1){
    ...
    _numuCCMultiPiPhotonSelection.SetDetectorFV(det, ibranch);
  }
  
protected:
  numuCCMultiPiPhotonSelection _numuCCMultiPiPhotonSelection;
  
};


class FillSummaryAction_numuCCMultiPiPhotonFGD2: public StepBase{
public:
