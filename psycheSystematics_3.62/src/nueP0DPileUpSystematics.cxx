...
//********************************************************************
  ...
  _fgd1 = new BinnedParams("nueFGD1_P0D_PileUp",BinnedParams::k1D_SYMMETRIC, versionUtils::ExtensionSyst());
  _fgd2 = new BinnedParams("nueFGD2_P0D_PileUp",BinnedParams::k1D_SYMMETRIC, versionUtils::ExtensionSyst());
...
//******************************************************************** 
void nueP0DPileUpSystematics::Print(Option_t *option) const{
  //******************************************************************** 
  (void)option;

  std::cout << " ***** Bins for the nueP0DPileUpSystematics ***** " << std::endl;
