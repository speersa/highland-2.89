...
namespace anaUtils{
    ...
    /// Compute the nucleus mass from its PDG code (format: 100ZZZAAAI).
    ///
    /// Returns AAA*u, where u is the unified atomic mass unit (u = 931.494 Mev/c^2).
    Float_t GetNucleusMass(int PDG );
