...
//*********************************************************
void BinnedParams::Print(unsigned int offset) const{
  //*********************************************************
  ...
  if (_type==k1D_SYMMETRIC){
    ...
    for (it=0;it<_nBins;it++, i++)
      std::cout << i + offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_mean << "\t " << _bins[it]->_sigma << std::endl;
  }
  else if (_type==k2D_SYMMETRIC){
    std::cout << "#: \t min1 \t max1 \t min2 \t max2 \t mean \t sigma" <<  std::endl;
    for (it=0; it<_nBins;it++, i++)
      std::cout << i + offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_min2 << "\t " 
    ...
    for (it=0; it<_nBins;it++, i++)
      std::cout << i + offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_min2 << "\t " << _bins[it]->_max2 
    ...
    for (it=0;it<_nBins;it++, i++)
      std::cout << i +offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_sigma << std::endl;
  }
    ...
    for (it=0;it<_nBins;it++, i++)
      std::cout << i + offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_mean << std::endl;
  }
    ...
    for (it=0; it<_nBins;it++, i++)
      std::cout << i + offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_meanREAL << "\t " 
    ...
    for (it=0; it<_nBins;it++, i++)
      std::cout << i + offset << ": \t " << _bins[it]->_min << "\t " << _bins[it]->_max << "\t " << _bins[it]->_meanREAL << "\t "<< _bins[it]->_meanMC << "\t " 
...
void BinnedParams::Read(const std::string& inputDirName, const std::string& extension){
  ...
  if (extension.length() > 0){
     inputFileName = inputDirName + "/" + _name + "_" +extension + ".dat";
  }
  else{
    inputFileName = inputDirName+"/" + _name + ".dat";
  } 
